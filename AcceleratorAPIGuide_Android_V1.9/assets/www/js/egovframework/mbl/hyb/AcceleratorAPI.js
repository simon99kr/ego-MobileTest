...
function fn_DelAccelerationInfoList() {
    /*
    var useYn = "";
    var acceleratorState = navigator.accelerator.connection.type;
    if(acceleratorState == Connection.NONE)
        useYn = "N";
    else
        useYn = "Y";
    var url = "/acl/btnDelAccelerationInfo.do"; 
    var accept_type = "json";
    var params = {uuid :  device.uuid,
            acceleratortype: acceleratorState, 
            useYn:  useYn};    */
...
$(function(){
    ...
    $('#accelratorInfoList').live('pageshow', function(event, ui) {
